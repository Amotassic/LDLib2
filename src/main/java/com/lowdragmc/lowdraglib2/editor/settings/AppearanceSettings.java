...
public class AppearanceSettings implements Settings {
    ...
    private static void setLightTexture(UIElement element, Property<IGuiTexture> property, IGuiTexture texture) {
    ...
    private static boolean isLightRuntimeFix(StyleSlot<?> slot) {
