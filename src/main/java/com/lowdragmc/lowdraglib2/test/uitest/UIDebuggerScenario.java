 ...
 *
 * <p>F3 opens it as a {@link DebugScreen} layered over the game — one keypress, nothing to know — and
...
public class UIDebuggerScenario implements UIScenario {
    ...
    public void define(ScenarioBuilder s) {
        openTarget(s)
                ...
                .group("F3 opens it over the game", g -> g
    ...
    static UIDebugger debugger(TestContext ctx) {
        var debugger = targetUI(ctx).getUiDebugger();
        if (debugger == null) {
